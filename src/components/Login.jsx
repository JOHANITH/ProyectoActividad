    ...
    <div className="login-container">
      ...
      {infoVisible === 1 && (
        <div className="info-page">
          ...
          <p>Visualizacion de la interfas donde se solicita el tipo de vehiculo, 
            placa y a su vez se muestra el numero de cupos tanto usados como disponibles de cada uno 
          </p>
          <img
          ...
          <img
            ...
            className="info-img"
          />
          <h3>Al eliminar el vehiculo se le da salida y a su vez muestra la factura</h3>
          <img
      ...
      {infoVisible === 2 && (
        <div className="info-page">
          <h2>Diseño e implementación de la base de datos para el sistema de parqueo</h2>
          <img
            src="https://res.cloudinary.com/dptqdghgv/image/upload/v1751230512/00_esquema_ytfsfl.png"
            alt="Parqueo"
            className="info-img"
          />
          <p>Diseño de la base de datos para el sistema de parqueo cubriendo los requerimientos funcionales.</p>
          <p>Diseño del Modelo de Entidad Relacion de los datos e implementacion en el manejador de bases de datos Postgree.</p>
          <img
            src="https://res.cloudinary.com/dptqdghgv/image/upload/v1751241340/02_Ruta_resgistro_de_parqueo_busqueda_-_sql_bpfswb.png"
            alt="Parqueo"
            className="info-img"
          />
          <p>Creacion de consultas SQL para manejo de la informacion funcionaliad adicional para el sistema.</p>
          <button className="btn-back" onClick={handleBack}>Volver</button>
        </div>
      )}
      ...
      {infoVisible === 3 && (
        <div className="info-page">
          <h2>Aplicacion funcional desplegada y conectada a la base de datos</h2>
          <img
            ...
            className="info-img"
          />
          <p>Aplicacion funcional desplegada con tecnologia React, Vite y conectada a la base de datos Postgre y consultas SQL.</p>
          <p>Utilización de RouterDom para optimizacion del desempeño de la aplicacion y despliegue en Render.</p>
          <button className="btn-back" onClick={handleBack}>Volver</button>
        </div>
      )}
    </div>
